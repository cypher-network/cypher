...
namespace CYPCore.Models
{
    ...
    public class BlockPos
    {
        ...
        public IEnumerable<ValidationResult> Validate()
        {
            ...
            if (Nonce != null && Nonce.Length != 77)
            {
                results.Add(new ValidationResult("Range exception", new[] { "Nonce" }));
            }
            if (VrfProof == null)
            {
                results.Add(new ValidationResult("Argument is null", new[] { "VrfProof" }));
            }
            ...
            if (VrfSig == null)
            {
                results.Add(new ValidationResult("Argument is null", new[] { "VrfSig" }));
            }
